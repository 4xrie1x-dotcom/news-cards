...
STOPWORDS = {
    ...
    "국무회의", "국회", "발표", "개최", "의결", "주재", "진행", "예정", "발의",
}
# "법안"은 불용어에 넣지 않는다 — "패트법", "클래리티 법안"처럼 구체적 법안명과
# 결합되면 오히려 사건을 특정해준다. 문제였던 건 "발의"와만 짝지어 아무 법안에나
# 붙는 것이었다(의원마다 다른 법안을 "OO법안 발의"라고만 써서 무관한 기사들이 묶임)
